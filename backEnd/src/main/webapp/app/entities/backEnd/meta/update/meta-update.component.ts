...
import { AlunoService } from 'app/entities/backEnd/aluno/service/aluno.service';
...
export class MetaUpdateComponent implements OnInit {
  ...
  protected updateForm(meta: IMeta): void {
    ...
    this.alunosSharedCollection = this.alunoService.addAlunoToCollectionIfMissing<IAluno>(this.alunosSharedCollection, meta.metaAluno);
  }
  ...
  protected loadRelationshipsOptions(): void {
    this.alunoService
      ...
      .pipe(map((alunos: IAluno[]) => this.alunoService.addAlunoToCollectionIfMissing<IAluno>(alunos, this.meta?.metaAluno)))
